...
Route::get('/pages/{id}/{key}/{lang?}/deleteMeta', '\App\Http\Controllers\PageController@deleteMetaFromPage')->name('deleteMeta');
...
Route::get('/pages/code/{code}/{lang?}', '\App\Http\Controllers\PageController@showPageWithCode')->name('post.code');